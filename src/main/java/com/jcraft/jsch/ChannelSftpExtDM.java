...
public class ChannelSftpExtDM extends ChannelSession {
	...
	public void start () throws JSchException {
		try {
			...
			PipedInputStream pis = new Channel.MyPipedInputStream (pos, rmpsize);
...
//    if(cwd.equals(getHome())) return path;
	...
	// Well, in reality it can be changed - DM
    /*
